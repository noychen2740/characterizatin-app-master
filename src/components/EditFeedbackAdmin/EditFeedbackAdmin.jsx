...
function EditFeedbackAdmin({ userFromDB }) {
  ...
  const PutUpdateFeed = async () => { //מחיקה של הפיידבק הספציפי לפי הקיי
    navigate(`/EditFeedbackAdmin/${FeedbackKey}`)
  };
  ...
  return ( //יצירה של הפידבק
    <div className='create-episode'>
      ...
      <NavigationAdmin pagNav={'Feedbacks'} />
    </div>
  );
}

export default EditFeedbackAdmin;
